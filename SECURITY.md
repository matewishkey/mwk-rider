...
Please **don't** open a public issue for a security problem. Use GitHub's [private vulnerability reporting](https://github.com/wishbusterz/rider/security/advisories/new) on this repository, which goes only to the maintainers.
